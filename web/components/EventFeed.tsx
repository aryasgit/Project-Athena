          ...
          return (
            ...
            >
              <div className="flex items-center gap-2">
                <span className="h-1.5 w-1.5 shrink-0" style={{ background: SEVERITY_COLOR[e.severity] }} aria-hidden />
              ...
              <p
                className="mono mt-1.5 text-[0.78rem] font-medium"
                style={{ color: crit ? "var(--color-phosphor)" : "var(--color-ash)" }}
              >
                {e.title}
              </p>
